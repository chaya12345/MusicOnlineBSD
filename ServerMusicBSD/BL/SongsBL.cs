    ...
    public class SongsBL
    {
            ...
            string imageName, string mailAddress, int songId, string songName, string singerName)
        {
            try
            {
                ...
                string linkToSong = "http://localhost:4200/song?songId=" + songId;
                var mainImage = new LinkedResource(AppDomain.CurrentDomain.BaseDirectory.Substring(0,
                                AppDomain.CurrentDomain.BaseDirectory.LastIndexOf("Server") - 1) + 
                                "\\DAL\\src\\images\\for_topics\\08312012-BOWERS-WILKINS-HEADPHONES-001edit.jpg");
                mainImage.ContentId = Guid.NewGuid().ToString();
                var logo = new LinkedResource(AppDomain.CurrentDomain.BaseDirectory.Substring(0,
                                AppDomain.CurrentDomain.BaseDirectory.LastIndexOf("Server") - 1) +
                                "\\DAL\\src\\images\\logo-bsd-black.png");
                ...
                // http://localhost:4200/assets/images/for_songs/%D7%90%D7%99%D7%A6%D7%99%D7%A7-%D7%93%D7%93%D7%99%D7%94/%D7%A0%D7%95%D7%A9%D7%90-%D7%AA%D7%A4%D7%99%D7%9C%D7%94-1920-960x540.jpg
                body = string.Format(@"​​​​​​​<div style=""background-color:#000000ad;background-blend-mode:multiply;background-size:cover;background-position:center;background-image:url(http://localhost:4200/assets/images/for_topics/08312012-BOWERS-WILKINS-HEADPHONES-001edit.jpg);""><p style=""text-align: center;""><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><span style=""color:#f1c40f;""><span style=""font-size:20px;""></span></span><span style=""font-size:22px;""><span style=""color:#ffffff;""><strong>מיוזיק אונליין</strong> מעדכן:</span></span><br></p><p style=""text-align: center;""><span><span style=""font-size:20px;""></span></span><span style=""color:#ffffff;""><span style=""font-size:10px;"">____________________________________________________________________________</span></span></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><span style=""font-size:16px""><em></em></span><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><br></p></div><p style=""text-align: center;""><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><span style=""font-size:20px""><span style=""color:#f1c40f""><strong>חדש!</strong></span> <span>{2} בשיר חדש - ""{3}""</span></span><br></p><p style=""text-align: center;""><span style=""font-size:20px""><span></span></span><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><a data-cke-saved-href=""{1}"" href=""{1}""><img data-cke-saved-src=""cid:{0}"" src=""cid:{0}"" style=""height: 220px;""></a><br></p><p style=""text-align: center;""><span style=""font-size:16px;""><em>לחץ <a data-cke-saved-href=""{1}"" href=""{1}""><strong>כאן</strong> </a>או על התמונה למעבר לשיר</em></span></p><p style=""text-align: center;""><span style=""font-size:16px;""><em></em></span><br></p><p style=""text-align: center;""><span style=""font-size:16px;""><em></em></span><br></p><p style=""text-align: center;""><br></p><p><span style=""font-size:16px;""><em></em></span><br></p><hr><p style=""text-align: center;""><a data-cke-saved-href=""http://localhost:4200/"" href=""http://localhost:4200/""><img data-cke-saved-src=""http://localhost:4200/assets/images/logo-bsd-black.png"" src=""http://localhost:4200/assets/images/logo-bsd-black.png"" style=""height:150px; width:162px""></a></p><p style=""text-align:center""><span style=""font-size:18px;"">עולם של <strong>מוזיקה יהודית</strong>,</span></p><p style=""text-align:center""><span style=""font-size:18px;"">בכל סגנון שתבחרו.</span></p><p style=""text-align:center""><span style=""font-size:18px;""></span><br></p><hr><p style=""text-align: center;""></p><p style=""text-align: center;""></p><p style=""text-align: center;""><a data-cke-saved-href=""http://localhost:4200/"" href=""http://localhost:4200/""></a></p>", inlineLogo.ContentId, linkToSong, singerName, songName);
                body = string.Format(@"​​​​​​​<div style=""background-color:#000000ad;background-blend-mode:multiply;background-size:cover;background-position:center;background-image:url({4});""><p style=""text-align: center;""><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><span style=""color:#f1c40f;""><span style=""font-size:20px;""></span></span><span style=""font-size:22px;""><span style=""color:#ffffff;""><strong>מיוזיק אונליין</strong> מעדכן:</span></span><br></p><p style=""text-align: center;""><span><span style=""font-size:20px;""></span></span><span style=""color:#ffffff;""><span style=""font-size:10px;"">____________________________________________________________________________</span></span></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><span style=""font-size:16px""><em></em></span><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><br></p></div><p style=""text-align: center;""><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><span style=""font-size:20px""><span style=""color:#f1c40f""><strong>חדש!</strong></span> <span>{2} בשיר חדש - ""{3}""</span></span><br></p><p style=""text-align: center;""><span style=""font-size:20px""><span></span></span><br></p><p style=""text-align: center;""><br></p><p style=""text-align: center;""><a data-cke-saved-href=""{1}"" href=""{1}""><img data-cke-saved-src=""cid:{0}"" src=""cid:{0}"" style=""height: 220px;""></a><br></p><p style=""text-align: center;""><span style=""font-size:16px;""><em>לחץ <a data-cke-saved-href=""{1}"" href=""{1}""><strong>כאן</strong> </a>או על התמונה למעבר לשיר</em></span></p><p style=""text-align: center;""><span style=""font-size:16px;""><em></em></span><br></p><p style=""text-align: center;""><span style=""font-size:16px;""><em></em></span><br></p><p style=""text-align: center;""><br></p><p><span style=""font-size:16px;""><em></em></span><br></p><hr><p style=""text-align: center;""><a data-cke-saved-href=""http://localhost:4200/"" href=""http://localhost:4200/""><img data-cke-saved-src=""cid:{5}"" src=""cid:{5}"" style=""height:150px; width:162px""></a></p><p style=""text-align:center""><span style=""font-size:18px;"">עולם של <strong>מוזיקה יהודית</strong>,</span></p><p style=""text-align:center""><span style=""font-size:18px;"">בכל סגנון שתבחרו.</span></p><p style=""text-align:center""><span style=""font-size:18px;""></span><br></p><hr><p style=""text-align: center;""></p><p style=""text-align: center;""></p><p style=""text-align: center;""><a data-cke-saved-href=""http://localhost:4200/"" href=""http://localhost:4200/""></a></p>", inlineLogo.ContentId, linkToSong, singerName, songName, mainImage, logo);

                var view = AlternateView.CreateAlternateViewFromString(body, null, "text/html");
                view.LinkedResources.Add(inlineLogo);
                view.LinkedResources.Add(mainImage);
