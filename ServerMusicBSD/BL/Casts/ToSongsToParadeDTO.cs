...
namespace BL.Casts
{
    ...
    {
        public static SongsToParadeDTO GetParade(SongsToParadeTBL Parade)
        {
            if (Parade == null)
                return null;
        ...
        public static List<SongsToParadeDTO> GetParades(List<SongsToParadeTBL> Parades)
        {
            if (Parades == null)
                return null;
            ...
            {
                SongsToParadeDTO Parade = GetParade(item);
                if (Parade != null)
                    list.Add(Parade);
            }
