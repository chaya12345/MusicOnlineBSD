...
export class FollowUpService {
  ...
  deleteFollowUp(userId: number, id: number, type: string): Observable<boolean> {
    return this.httpClient.delete<boolean>(this.baseUrl + 'DeleteFollowUp?userId=' + userId + '&id=' + id + '&type=' + type);
  }
